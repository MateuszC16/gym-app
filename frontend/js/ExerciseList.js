class ExerciseList {
  constructor() {
    ...
    this.addMuscleGroupFilter(); // Dodajemy nasłuchiwanie na zmiany w select
  }
  ...
  // Funkcja nasłuchująca zmiany w select i przekazująca wybraną partię mięśniową
  addMuscleGroupFilter() {
    ...
    muscleGroupSelect.addEventListener('change', (event) => {
      ...
      this.renderExercises(selectedMuscleGroup);  // Renderowanie ćwiczeń na podstawie wybranego filtra
    });
  }
